...
import com.clarabernerd.myapp.repository.OrderRepository;
...
class OrderResourceIT {
    ...
    private static final String DEFAULT_PICKUP_ADDR = "AAAAAAAAAA";
    private static final String UPDATED_PICKUP_ADDR = "BBBBBBBBBB";
    ...
    public static Order createEntity(EntityManager em) {
        Order order = new Order().pickupAddr(DEFAULT_PICKUP_ADDR).deliveryAddr(DEFAULT_DELIVERY_ADDR);
        return order;
    }
    ...
    public static Order createUpdatedEntity(EntityManager em) {
        Order order = new Order().pickupAddr(UPDATED_PICKUP_ADDR).deliveryAddr(UPDATED_DELIVERY_ADDR);
        return order;
    }
    ...
    void createOrder() throws Exception {
        ...
        assertThat(testOrder.getPickupAddr()).isEqualTo(DEFAULT_PICKUP_ADDR);
        assertThat(testOrder.getDeliveryAddr()).isEqualTo(DEFAULT_DELIVERY_ADDR);
    }
    ...
    void getAllOrders() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.[*].pickupAddr").value(hasItem(DEFAULT_PICKUP_ADDR)))
    ...
    void getOrder() throws Exception {
        ...
        restOrderMockMvc
            ...
            .andExpect(jsonPath("$.pickupAddr").value(DEFAULT_PICKUP_ADDR))
    ...
    void putNewOrder() throws Exception {
        ...
        updatedOrder.pickupAddr(UPDATED_PICKUP_ADDR).deliveryAddr(UPDATED_DELIVERY_ADDR);
        ...
        Order testOrder = orderList.get(orderList.size() - 1);
        assertThat(testOrder.getPickupAddr()).isEqualTo(UPDATED_PICKUP_ADDR);
        assertThat(testOrder.getDeliveryAddr()).isEqualTo(UPDATED_DELIVERY_ADDR);
    }
    ...
    void partialUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.pickupAddr(UPDATED_PICKUP_ADDR);
    ...
    void fullUpdateOrderWithPatch() throws Exception {
        ...
        partialUpdatedOrder.pickupAddr(UPDATED_PICKUP_ADDR).deliveryAddr(UPDATED_DELIVERY_ADDR);
