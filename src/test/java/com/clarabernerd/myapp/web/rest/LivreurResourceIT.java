...
import com.clarabernerd.myapp.repository.LivreurRepository;
...
class LivreurResourceIT {
    ...
    private static final Integer DEFAULT_TOTAL_EARNINGS = 1;
    private static final Integer UPDATED_TOTAL_EARNINGS = 2;

    private static final Integer DEFAULT_TOTAL_RIDES = 1;
    private static final Integer UPDATED_TOTAL_RIDES = 2;
    ...
    public static Livreur createEntity(EntityManager em) {
        Livreur livreur = new Livreur()
            ...
            .totalRides(DEFAULT_TOTAL_RIDES)
    ...
    public static Livreur createUpdatedEntity(EntityManager em) {
        Livreur livreur = new Livreur()
            ...
            .totalRides(UPDATED_TOTAL_RIDES)
    ...
    void createLivreur() throws Exception {
        ...
        assertThat(testLivreur.getTotalEarnings()).isEqualTo(DEFAULT_TOTAL_EARNINGS);
        assertThat(testLivreur.getTotalRides()).isEqualTo(DEFAULT_TOTAL_RIDES);
    ...
    void getAllLivreurs() throws Exception {
        ...
        restLivreurMockMvc
            ...
            .andExpect(jsonPath("$.[*].totalEarnings").value(hasItem(DEFAULT_TOTAL_EARNINGS)))
            .andExpect(jsonPath("$.[*].totalRides").value(hasItem(DEFAULT_TOTAL_RIDES)))
    ...
    void getLivreur() throws Exception {
        ...
        restLivreurMockMvc
            ...
            .andExpect(jsonPath("$.totalEarnings").value(DEFAULT_TOTAL_EARNINGS))
            .andExpect(jsonPath("$.totalRides").value(DEFAULT_TOTAL_RIDES))
    ...
    void putNewLivreur() throws Exception {
        ...
        assertThat(testLivreur.getTotalEarnings()).isEqualTo(UPDATED_TOTAL_EARNINGS);
        assertThat(testLivreur.getTotalRides()).isEqualTo(UPDATED_TOTAL_RIDES);
