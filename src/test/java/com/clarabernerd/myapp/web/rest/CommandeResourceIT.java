...
import com.clarabernerd.myapp.repository.CommandeRepository;
...
class CommandeResourceIT {
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().pickupAddress(DEFAULT_PICKUP_ADDRESS).deliveryAddress(DEFAULT_DELIVERY_ADDRESS);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().pickupAddress(UPDATED_PICKUP_ADDRESS).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
        return commande;
    }
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getPickupAddress()).isEqualTo(DEFAULT_PICKUP_ADDRESS);
    ...
    void putNewCommande() throws Exception {
        ...
        updatedCommande.pickupAddress(UPDATED_PICKUP_ADDRESS).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
        ...
        Commande testCommande = commandeList.get(commandeList.size() - 1);
        assertThat(testCommande.getPickupAddress()).isEqualTo(UPDATED_PICKUP_ADDRESS);
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.pickupAddress(UPDATED_PICKUP_ADDRESS);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.pickupAddress(UPDATED_PICKUP_ADDRESS).deliveryAddress(UPDATED_DELIVERY_ADDRESS);
