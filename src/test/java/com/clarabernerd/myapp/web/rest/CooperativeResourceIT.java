...
import com.clarabernerd.myapp.repository.CooperativeRepository;
...
class CooperativeResourceIT {
    ...
    private static final Integer DEFAULT_SHOP_COUNT = 1;
    private static final Integer UPDATED_SHOP_COUNT = 2;
    ...
    public static Cooperative createEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().city(DEFAULT_CITY).shopCount(DEFAULT_SHOP_COUNT);
        return cooperative;
    }
    ...
    public static Cooperative createUpdatedEntity(EntityManager em) {
        Cooperative cooperative = new Cooperative().city(UPDATED_CITY).shopCount(UPDATED_SHOP_COUNT);
        return cooperative;
    }
    ...
    void createCooperative() throws Exception {
        ...
        assertThat(testCooperative.getShopCount()).isEqualTo(DEFAULT_SHOP_COUNT);
    }
    ...
    void getAllCooperatives() throws Exception {
        ...
        restCooperativeMockMvc
            ...
            .andExpect(jsonPath("$.[*].shopCount").value(hasItem(DEFAULT_SHOP_COUNT)));
    }
    ...
    void getCooperative() throws Exception {
        ...
        restCooperativeMockMvc
            ...
            .andExpect(jsonPath("$.shopCount").value(DEFAULT_SHOP_COUNT));
    }
    ...
    void putNewCooperative() throws Exception {
        ...
        updatedCooperative.city(UPDATED_CITY).shopCount(UPDATED_SHOP_COUNT);
        ...
        assertThat(testCooperative.getShopCount()).isEqualTo(UPDATED_SHOP_COUNT);
    }
    ...
    void partialUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.shopCount(UPDATED_SHOP_COUNT);
    ...
    void fullUpdateCooperativeWithPatch() throws Exception {
        ...
        partialUpdatedCooperative.city(UPDATED_CITY).shopCount(UPDATED_SHOP_COUNT);
