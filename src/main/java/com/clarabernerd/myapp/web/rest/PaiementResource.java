...
/**
 * REST controller for managing {@link com.clarabernerd.myapp.domain.Paiement}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Paiement> partialUpdatePaiement(
        ...
        Optional<Paiement> result = paiementRepository
            ...
            .map(existingPaiement -> {
                ...
                if (paiement.getPaiementType() != null) {
                    existingPaiement.setPaiementType(paiement.getPaiementType());
                }
