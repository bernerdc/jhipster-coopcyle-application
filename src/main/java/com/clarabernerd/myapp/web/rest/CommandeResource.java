...
/**
 * REST controller for managing {@link com.clarabernerd.myapp.domain.Commande}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Commande> partialUpdateCommande(
        ...
        Optional<Commande> result = commandeRepository
            ...
            .map(existingCommande -> {
                if (commande.getPickupAddress() != null) {
                    existingCommande.setPickupAddress(commande.getPickupAddress());
                }
                if (commande.getDeliveryAddress() != null) {
                    existingCommande.setDeliveryAddress(commande.getDeliveryAddress());
                }
