...
/**
 * REST controller for managing {@link com.clarabernerd.myapp.domain.Cooperative}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Cooperative> partialUpdateCooperative(
        ...
        Optional<Cooperative> result = cooperativeRepository
            ...
            .map(existingCooperative -> {
                ...
                if (cooperative.getShopCount() != null) {
                    existingCooperative.setShopCount(cooperative.getShopCount());
                }
