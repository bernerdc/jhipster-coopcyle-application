...
/**
 * REST controller for managing {@link com.clarabernerd.myapp.domain.Payment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Payment> partialUpdatePayment(
        ...
        Optional<Payment> result = paymentRepository
            ...
            .map(existingPayment -> {
                ...
                if (payment.getPaiementType() != null) {
                    existingPayment.setPaiementType(payment.getPaiementType());
                }
